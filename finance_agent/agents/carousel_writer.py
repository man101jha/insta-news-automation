        ...
        prompt = ChatPromptTemplate.from_messages([
            ("system", (
                ...
                "Your task is to convert 5 financial news stories into a high-converting, premium-looking 7-slide Instagram carousel.\n\n"
                 ...
                 "   - Body: A detailed 7-8 line paragraph of high-impact sans-serif body text (approximately 90-110 words total). Synthesis: Use the original 'description' field and the 'retail_impact_summary' to construct a comprehensive explanation of what happened, why it happened, and its direct actionability/consequences for a retail investor's savings, mutual funds, or stock portfolio. Provide deep, high-quality, dense information to fill the layout space beautifully.\n"
